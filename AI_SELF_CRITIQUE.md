...
- Conviction sizing is working: Tier 1 +0.3% > Tier 3 -0.7%

## Systematic Biases / Errors ⚠️
- 'high_sharpe' rationale is weak: -0.0% avg, 39% hit rate
- 'non_us_differentiator' rationale is weak: -0.2% avg, 25% hit rate
...
|---|---:|---:|---:|
| momentum | 77 | +0.19% | 43% |
| high_sharpe | 67 | -0.04% | 39% |
| breakout | 11 | +0.01% | 45% |
| consensus | 62 | +0.18% | 42% |
| catalyst | 10 | +0.85% | 60% |
| diversifier | 4 | -0.40% | 50% |
| non_us_differentiator | 32 | -0.17% | 25% |
| overbought | 38 | -0.01% | 47% |
| at_52w_high | 54 | +0.37% | 48% |

## Conviction Sizing Accuracy
| Tier | Weight Range | Observations | Avg Return |
|---|---|---:|---:|
| Tier 1 (high conviction) | 20-25% | 38 | +0.29% |
| Tier 2 (medium conviction) | 12-18% | 43 | +0.19% |
...
- RATIONALE CAP: cap any position whose primary thesis is 'non_us_differentiator' at 15% — hit rate 25% over 32 observations (threshold: 30%).
